...
class LoginForm(forms.Form):
    username = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder' : 'شماره تماس یا ایمیل'}))
    ...
    def clean_username(self):
        ...
        if len(username) > 40:
            raise ValidationError("شماره تلفن یا ایمیل وارد شده معتبر نیست", code="invalid",params={'valid': f'{username}'},)
